...
[**Report a vulnerability**](https://github.com/hassio-addons/app-jellyfin/security/advisories/new)
...
- Issues in Jellyfin itself; please report those directly to the
...
This security policy covers the Jellyfin app in this repository: the app
